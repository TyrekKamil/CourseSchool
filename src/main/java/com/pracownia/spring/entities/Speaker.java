...
{
    public Speaker(String imie, String nazwisko, Address adres, String pesel) {
        this.imie = imie;
    ...
    public Speaker(String imie, String nazwisko, Address adres, List<Course> course, String pesel) {
        this.imie = imie;
        this.nazwisko = nazwisko;
        this.adres = adres;
        this.course = course;
